...
## ⚙️ How It Works
1. **Database Connection:** Connects to the MySQL database using `mysql-connector-python`.
2. **Data Ingestion:** Inserts retail data records into the database using bulk insert operations.
